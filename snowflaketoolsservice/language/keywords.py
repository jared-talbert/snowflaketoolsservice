...
from snowflaketoolsservice.language.contracts import CompletionItem, CompletionItemKind, TextEdit
from snowflaketoolsservice.workspace.contracts.common import Range
