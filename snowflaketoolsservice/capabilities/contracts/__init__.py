...
from snowflaketoolsservice.capabilities.contracts.capabilities_request import (
...
from snowflaketoolsservice.capabilities.contracts.initialize_request import (
    INITIALIZE_REQUEST,
