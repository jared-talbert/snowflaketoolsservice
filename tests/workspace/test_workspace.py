...
from snowflaketoolsservice.workspace.workspace import ScriptFile, Workspace
...
class TestWorkspaceService(unittest.TestCase):
    ...
    def test_open_file_no_buffer(self):
        # Setup: Patch open()
        m = mock.mock_open()
        with mock.patch('snowflaketoolsservice.workspace.workspace.open', m, create=True):
    ...
    def test_resolve_file_path_windows(self):
        ...
        with mock.patch('snowflaketoolsservice.workspace.workspace.os.name', 'nt'):
            for test in tests:
    ...
    def test_resolve_file_path_posix(self):
        ...
        with mock.patch('snowflaketoolsservice.workspace.workspace.os.name', 'posix'):
            for test in tests:
