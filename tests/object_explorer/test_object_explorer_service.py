...
from snowflakesqltoolsservice.connection.contracts import ConnectionDetails, ConnectionCompleteParams
from snowflakesqltoolsservice.hosting import JSONRPCServer, RequestContext, ServiceProvider  # noqa
from snowflakesqltoolsservice.metadata.contracts import ObjectMetadata
from snowflakesqltoolsservice.object_explorer.object_explorer_service import ObjectExplorerService, ObjectExplorerSession
from snowflakesqltoolsservice.object_explorer.contracts import (
...
class TestObjectExplorer(unittest.TestCase):
    ...
    def test_handle_create_session_threading_fail(self):
        ...
        patch_path = 'snowflakesqltoolsservice.object_explorer.object_explorer_service.threading.Thread'
    ...
    def _handle_er_exception_expanding(self, method: TEventHandler, get_tasks: TGetTask):
        ...
        # ... Patch the threading to throw
        patch_mock = mock.MagicMock(side_effect=Exception('Boom!'))
        patch_path = 'snowflakesqltoolsservice.object_explorer.object_explorer_service.route_request'
        with mock.patch(patch_path, patch_mock):
