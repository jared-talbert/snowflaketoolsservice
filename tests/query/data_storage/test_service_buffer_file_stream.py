...
import snowflaketoolsservice.query.data_storage.service_buffer_file_stream as stream
from snowflaketoolsservice.query.data_storage import ServiceBufferFileStreamWriter, ServiceBufferFileStreamReader
...
class TestServiceBufferFileStream(unittest.TestCase):
    ...
    def test_get_file_name(self):
        ...
        with mock.patch('snowflaketoolsservice.query.data_storage.service_buffer_file_stream.tempfile', new=tempfile_mock):
            stream.create_file()
    ...
    def test_get_reader(self):
        ...
        with mock.patch('snowflaketoolsservice.query.data_storage.service_buffer_file_stream.io', new=io_mock):
