...
from snowflakesqltoolsservice.edit_data import SmoEditTableMetadataFactory
from tests.utils import MockConnection
from snow import Server, Table, View, Column
...
class TestSmoEditTableMetadataFactory(unittest.TestCase):
    ...
    def test_get_with_table_type(self):
        ...
        with mock.patch('snowflakesqltoolsservice.utils.object_finder.find_table', new=mock.Mock(return_value=table)):
    ...
    def test_get_with_view_type(self):
        ...
        with mock.patch('snowflakesqltoolsservice.utils.object_finder.find_view', new=mock.Mock(return_value=view)):
