...
from snow.objects.scripting_mixins import ScriptableBase, ScriptableCreate, ScriptableDelete, ScriptableUpdate
...
class ScriptableTestBase(metaclass=ABCMeta):
    ...
    def test_script(self):
        ...
        mock_path = 'path.sql'
        mock_output = 'sql'
        template_path_path = "snow.objects.scripting_mixins.templating.get_template_path"
        template_path_mock = mock.MagicMock(return_value=mock_path)
        template_render_path = "snow.objects.scripting_mixins.templating.render_template"
