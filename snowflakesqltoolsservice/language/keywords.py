...
from snowflakesqltoolsservice.language.contracts import CompletionItem, CompletionItemKind, TextEdit
from snowflakesqltoolsservice.workspace.contracts.common import Range
