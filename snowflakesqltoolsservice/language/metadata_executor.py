...
from snow import Column, Database, Schema, Server, NodeCollection, Function, Table, View       # noqa
from snowflakesqltoolsservice.language.completion.packages.parseutils.meta import ColumnMetadata, ForeignKey, FunctionMetadata     # noqa
...
class MetadataExecutor:
    """
    Handles querying metadata from snow and returning it in a form usable by the
    autocomplete code
    """
