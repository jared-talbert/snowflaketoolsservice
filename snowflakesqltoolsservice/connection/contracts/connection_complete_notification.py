...
from snowflakesqltoolsservice.connection.contracts.common import ConnectionSummary, ConnectionType     # noqa
...
class ServerInfo(object):
    """Contract for information on the connected Snowflake server"""
