...
from snowflakesqltoolsservice.connection import ConnectionInfo
from snowflakesqltoolsservice.disaster_recovery.contracts import BACKUP_REQUEST, BackupParams, BackupType, RESTORE_REQUEST, RestoreParams
...
def _get_pg_exe_path(exe_name: str) -> str:
    """
    Find the path to the given Snowflake utility executable for the current operating system
