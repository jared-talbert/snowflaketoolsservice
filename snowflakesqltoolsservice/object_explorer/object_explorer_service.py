...
from snowflakesqltoolsservice.connection.contracts import ConnectRequestParams, ConnectionDetails, ConnectionType
...
from snowflakesqltoolsservice.object_explorer.routing import route_request
...
class ObjectExplorerService(object):
    ...
    def _initialize_session(self, request_context: RequestContext, session: ObjectExplorerSession):
        ...
        try:
            ...
            # Step 3: Create the snow Server object for the session and create the root node for the server
