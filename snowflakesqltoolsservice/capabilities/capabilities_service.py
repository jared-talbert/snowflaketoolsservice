...
from snowflakesqltoolsservice.capabilities.contracts import (
...
from snowflakesqltoolsservice.disaster_recovery.contracts import BACKUP_OPTIONS, RESTORE_OPTIONS
...
from snowflakesqltoolsservice.query_execution.contracts import SERIALIZATION_OPTIONS
    ...
    def _handle_dmp_capabilities_request(
        ...
        conn_provider_opts = ConnectionProviderOptions([
            ConnectionOption(
                ...
                description='Name of the Snowflake instance',
        ...
        capabilities = DMPServerCapabilities('1.0', 'PGSQL', 'Snowflake', conn_provider_opts, [BACKUP_OPTIONS, RESTORE_OPTIONS, SERIALIZATION_OPTIONS])
