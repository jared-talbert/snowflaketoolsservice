...
from snowflakesqltoolsservice.capabilities.contracts.capabilities_request import (
...
from snowflakesqltoolsservice.capabilities.contracts.initialize_request import (
    INITIALIZE_REQUEST,
