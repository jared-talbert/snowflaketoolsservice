...
from snowflakesqltoolsservice.disaster_recovery.disaster_recovery_service import DisasterRecoveryService
...
from snowflakesqltoolsservice.object_explorer import ObjectExplorerService
from snowflakesqltoolsservice.query_execution import QueryExecutionService
...
from snowflakesqltoolsservice.tasks import TaskService
...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('snowflakesqltoolsservice')
    try:
        if not log_dir:
